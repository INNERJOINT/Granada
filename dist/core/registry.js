function normalizeEntry(entry) {
    if (!entry || typeof entry !== 'object')
        throw new TypeError('hook entry is required');
    if (typeof entry.event !== 'string' || !entry.event)
        throw new TypeError('hook entry event is required');
